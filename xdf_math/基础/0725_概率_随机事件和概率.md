...
<img src="C:\Users\mioto\AppData\Roaming\Typora\typora-user-images\image-20200803133253066.png" alt="image-20200803133253066" style="zoom:50%;" />

#### 4.5 全概率公式

利用互斥可加的性质得到的

A是一个复杂事件，将它分解成若干个简单事件再来求它的概率

> 一定要是完备事件组才能用

<img src="C:\Users\mioto\AppData\Roaming\Typora\typora-user-images\image-20200803133518991.png" alt="image-20200803133518991" style="zoom:50%;" />

贝叶斯公式，是建立在全概率公式上的

条件公式比上全概率公式就是贝叶斯公式

<img src="C:\Users\mioto\AppData\Roaming\Typora\typora-user-images\image-20200803134448959.png" alt="image-20200803134448959" style="zoom:50%;" />

从贝叶斯公式也可以知道P(A)P(Bi|A) = P(Bi)P(A|Bi)，前后事件的角色是等价的

#### 4.5.1 例题 全概率公式和贝叶斯公式

可以知道白球一定来自于三个箱子之一，所以是一个完备事件组

<img src="C:\Users\mioto\AppData\Roaming\Typora\typora-user-images\image-20200803134352956.png" alt="image-20200803134352956" style="zoom:50%;" />

<img src="C:\Users\mioto\AppData\Roaming\Typora\typora-user-images\image-20200803134509511.png" alt="image-20200803134509511" style="zoom:50%;" />

> 后面的二维随机变量还会用到这里的基础

早年真题

<img src="C:\Users\mioto\AppData\Roaming\Typora\typora-user-images\image-20200803135246920.png" alt="image-20200803135246920" style="zoom:50%;" />

> 这道题目我也没看懂，讲题太快了
>
> 不知道为什么P(BiA)直接就从P(A|Bi)P(Bi)跳到了P(Bi)(A)，因为这里两个事件独立吗？
>
> 仔细看了一下，可能是因为这里的P(A|Bi)在题目里面就写了，就是当产品来自A的时候取到次品的情况，所以直接乘以0.01
